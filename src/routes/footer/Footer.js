...
const Footer = () => {
  return (
    <Fragment>
    <footer aria-label="Site Footer" className="bg-[#f7dfafea] mb-12">
    ...
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      >
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            >
              ...
              <button
                className="mt-1 w-full  bg-[orangered] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:flex-shrink-0"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">Your wildlife</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">Help & Service</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">Top categories</p>
